...
import { BLANK_CONTENT, getPreset } from '../../shared/presets.js';
import { addBoard, addCodeFile, addDocument } from '../../shared/schema.js';
import { newId } from './util.js';

/** 프리셋 + 선택한 기능으로 새 템플릿의 초기 내용을 만든다 */
export function seedTemplateDoc(doc: Y.Doc, presetId: string, features: Feature[], createdBy: string): void {
