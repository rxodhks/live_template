...
/*
 * 로그인 · 가입
 *  1) 외부 계정(구글 · 깃허브 · 애플) 또는 이메일 인증 코드로 본인 확인
...
const PROVIDERS: { id: OAuthProvider; label: string; icon: ReactNode }[] = [
  ...
  { id: 'apple', label: 'Apple로 계속하기', icon: <AppleLogo /> },
];

const PROVIDER_NAME: Record<string, string> = { google: 'Google', github: 'GitHub', apple: 'Apple', email: '이메일' };
...
function AppleLogo() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden fill="currentColor">
      <path d="M16.37 12.73c-.02-2.3 1.88-3.4 1.96-3.46-1.07-1.56-2.73-1.77-3.32-1.8-1.41-.14-2.76.83-3.47.83-.72 0-1.82-.81-2.99-.79-1.54.02-2.96.9-3.75 2.27-1.6 2.78-.41 6.89 1.15 9.14.76 1.1 1.67 2.34 2.86 2.3 1.15-.05 1.58-.74 2.97-.74 1.38 0 1.77.74 2.98.72 1.23-.02 2.02-1.12 2.77-2.23.88-1.28 1.24-2.52 1.26-2.59-.03-.01-2.4-.92-2.42-3.65zM14.1 5.98c.63-.77 1.06-1.83.94-2.9-.91.04-2.02.61-2.67 1.37-.58.67-1.1 1.76-.96 2.8 1.02.08 2.05-.51 2.69-1.27z" />
    </svg>
  );
}
